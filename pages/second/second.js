...
create(store, {
  ...
  onLoad: function () {
    ...
    secondRequest({type: '9', areaid: area.id, limit: 40}).then(res => {
      if (res.errno == 0) {
        //当前时间点
  ...
  listRequest(time){
    ...
    secondRequest({type: '9', areaid: area.id, limit: 40, nowtime: time}).then(res => {
      if (res.errno == 0) {
        if(res.timeArr.length && res.products.length) {
          ...
          this.setData({
            secondList: tuanCouponImgUrlAppend(res.products)
          })
        }
      }
    })
  ...
  gotoSecond(event) {
    ...
    let item = this.data.secondList[index]
...
page: "1"
pages: "1"
products: [{pid: "8715", name: "test寿仙谷胎菊 菊花茶50g/罐",…}]
0: {pid: "8715", name: "test寿仙谷胎菊 菊花茶50g/罐",…}
timeArr: ["19"]
*/
...
brandname: "寿仙谷"
cprice: "0"
end_time: "2019-09-18 19:43:44"
imgs: ["/upload/2018050511014765809461.jpg", "/upload/2018052409335978736035.jpg",…]
market_price: "1"
name: "test寿仙谷胎菊 菊花茶50g/罐"
parameter: ""
pid: "8715"
price: "1"
sales: "0"
shopid: "54"
shopname: "金华寿仙谷药业有限公司"
sku: "优选当年新花;无添加无硫熏"
star: "4.2"
start_time: "2019-09-18 09:43:39"
stock: "10"
subtitle: "优选当年新花;无添加无硫熏"
*/
